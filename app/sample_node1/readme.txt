	...
	TOPPRES/A-COMSTACK サンプルプログラム実行手順

本ドキュメントは，TOPPRES/A-COMSTACKの動作確認のためのサンプルプログラムを
...
atk2-sc1  /cfg/cfg/cfg.exe
            :
a-comstack/app/sample_nodeX/Makefile -> SRCDIR="../../../atk2-sc1"

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
(4) コンフィギュレーション
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

AUTOSAR仕様に従って，すべてのコンフィギュレーション情報をcomstack.arxmlとして作
成する．付属のXML生成ツールを用いると，YAMLフォーマットで記述した
...
以下のコマンドにより，comstack.arxmlからコンフィギュレーションに従ったファイ
ル群を生成する．

$ cd a-comstack/app/sample_nodeX
$ make configall

※comstack.arxmlとは別のarxmlからジェネレーションを実行したい場合，
  MakefileのそれぞれのXXXXX_CFGNAMEを変更する
※ジェネレーションしたファイルを削除する場合は以下を実行する
  $ make configallclean

各コンフィグレーションを個別で実行したい場合は以下を実行する
