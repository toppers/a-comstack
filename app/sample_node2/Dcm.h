 ...
 *  の責任を負わない．
 *
 *  $Id: Dcm.h 3480 2017-03-08 11:51:15Z suzuki-kawaguchi $
 */
...
#define DCM_RCV_OFF 0
#define DCM_RCV_ON 1

#define DCM_SND_IDLE 0
#define DCM_SND_PROC 1

#define DCM_RCV_IDLE 0
#define DCM_RCV_PROC 1

typedef struct dcm_config_type {
	PduIdType			*PduRId;
} Dcm_ConfigType;
...
extern BufReq_ReturnType Dcm_CopyTxData(PduIdType id, PduInfoType *info, RetryInfoType *retry, PduLengthType *availableDataPtr);

extern Std_ReturnType Transmit_functionality(PduIdType id, uint8 data[], PduLengthType len);
extern void Data_Confirmation_functionality(PduIdType id, Std_ReturnType result);
extern void Data_Indication_functionality(PduIdType id, PduInfoType *info, Std_ReturnType result);
