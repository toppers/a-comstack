...
#  の責任を負わない．
#
#  $Id: get_impl_id.rb 3480 2017-03-08 11:51:15Z suzuki-kawaguchi $
#
...
# 書き出すファイル
sWriteFileId = File.dirname(__FILE__) + "/cantp_impl_id.txt"

# 対象ソースコード
aTargetFiles = []
aTargetFiles.push("#{TOOL_ROOT}/../CanTp.c")
aTargetFiles.push("#{TOOL_ROOT}/../CanTp.h")
aTargetFiles.push("#{TOOL_ROOT}/../CanTp.tf")
