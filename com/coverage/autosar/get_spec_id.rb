...
#=====================================================================
# テキストファイル(AUTOSAR_SWS_COM_R4.0.3.txt)から，COMに関する仕様タグ
# を抜き出して，ID一覧をファイルへ出力する
...
# pdfから読み出したテキストデータ
sTextFile = "AUTOSAR_SWS_COM_R4.0.3.txt"
...
# 対象タグを検索する
aData1 = sText.scan(/\[COM[0-9][0-9][0-9]\]/)
aData2 = sText.scan(/COM[0-9][0-9][0-9]_Conf\s:/)
nData1 = aData1.size()
nData2 = aData2.size()

# COM771だけイレギュラーフォーマットなので手動で追加する
aTags = aData1 + aData2 + ["COM771"]
