...
#  の責任を負わない．
#
#  $Id: get_spec_id.rb 13 2015-07-15 08:58:53Z fujisft-kaitori $
#

#=====================================================================
# テキストファイル(AUTOSAR_SWS_CANDriver_R4.0.3.txt)から，CANIFに関する
# 仕様タグを抜き出して，ID一覧をファイルへ出力する
...
# pdfから読み出したテキストデータ
sTextFile = "AUTOSAR_SWS_CANDriver_R4.0.3.txt"
...
# 対象タグを検索する
aData1 = sText.scan(/\[CAN[0-9][0-9][0-9]\]/) + sText.scan(/CAN[0-9][0-9][0-9]:\s/)
aData2 = sText.scan(/CAN[0-9][0-9][0-9]_Conf\s:/)
nData1 = aData1.size()
nData2 = aData2.size()

# イレギュラーフォーマットを手動で追加する
aTags = aData1 + aData2 + ["CAN026", "CAN028", "CAN091", "CAN089", "CAN080"]
